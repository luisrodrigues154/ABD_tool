...
/* Primitives */
    ...
    { "abd_verbose", do_watcher, 6, 100, 0, { PP_FUNCTION, PREC_FN, 0 } },
...
attribute_hidden
SEXP
installS3Signature(const char *className, const char *methodName)
{
...
SEXP attribute_hidden do_internal(SEXP call, SEXP op, SEXP args, SEXP env)
{
    ...
    if (flag < 2 && flag == R_Visible)
    {
        ...
        if (strcmp(nm, "eval") && strcmp(nm, "options") && strcmp(nm, "Recall") && strcmp(nm, "do.call") && strcmp(nm, "switch") && strcmp(nm, "recordGraphics") && strcmp(nm, "writeBin") && strcmp(nm, "NextMethod"))
